...
export const expertsApi = {
  ...
  createExpert: (data: Omit<Expert, "id" | "createdAt" | "workload">) =>
    api.post<Expert>("/experts", data),
  updateExpert: (id: string, data: Partial<Expert>) =>
    api.put<Expert>(`/experts/${id}`, data),
  deleteExpert: (id: string) => api.delete(`/experts/${id}`),
};

export const assignmentsApi = {
  assignCase: (data: Omit<Assignment, "id" | "assignedAt">) =>
