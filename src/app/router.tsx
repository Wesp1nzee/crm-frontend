...
const CaseListPage = lazy(() =>
  import("../pages/cases/CaseListPage").then((m) => ({
    default: m.CaseListPage,
  })),
);
...
const ClientListPage = lazy(() =>
  import("../pages/clients/ClientListPage").then((m) => ({
...
const ExpertsPage = lazy(() =>
  import("../pages/experts/ExpertsPage").then((m) => ({
    default: m.ExpertsPage,
  })),
);
