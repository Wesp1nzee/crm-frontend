...
export function PublicHomePage() {
  ...
  const handleBlur = (
    ...
    if (allErrors[id as keyof FormErrors]) {
      setFormErrors((prev) => ({
        ...prev,
        [id]: allErrors[id as keyof FormErrors],
      }));
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setResponseMessage({
          text: "Ошибка отправки. Попробуйте позже или позвоните нам.",
          type: "error",
        });
      }
    } catch {
      setResponseMessage({
        text: "Сетевая ошибка. Пожалуйста, проверьте соединение и попробуйте снова.",
        type: "error",
      });
    } finally {
      ...
      <section className="hero" id="hero">
        <div className="container">
          <div className="hero-content">
            ...
            <p>
              ООО «ЭКСПЕРТИЗА» специализируется на проведении судебных экспертиз
              и экспертных исследований в различных областях. Качество и
              надежность с 2022 года.
            </p>
        ...
        <div className="container">
          ...
          <div className="about-content">
            <div className="about-text">
              <p>
                ООО «Экспертиза» специализируется на проведении судебных
                экспертиз и экспертных исследований. Все экспертизы выполняются
                квалифицированными специалистами в установленный судом срок.
              </p>
              <p>
                Наши эксперты работают не только в Барнауле, но и по всему
                Алтайскому краю: выезжаем для проведения исследований в Бийск,
                ...
                <div className="stats-grid">
                  <div className="stat-card">
                    ...
                    <ul className="stat-details">
                      <li>
                        Землеустроительные: <strong>16</strong>
                      </li>
                      <li>
                        Строительно-технические: <strong>85</strong>
                      </li>
                      <li>
                        Оценочные: <strong>19</strong>
                      </li>
                    </ul>
                  </div>
                  <div className="stat-card">
                    ...
                    <ul className="stat-details">
                      <li>
                        Землеустроительные: <strong>28</strong>
                      </li>
                      <li>
                        Строительно-технические: <strong>90</strong>
                      </li>
                      <li>
                        Оценочные: <strong>62</strong>
                      </li>
                      <li>
                        Пожарно-технические: <strong>3</strong>
                      </li>
                      <li>
                        Финансово-бухгалтерские: <strong>5</strong>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="guarantees-container">
                ...
                <ul>
                  <li>
                    Средний срок проведения экспертиз —{" "}
                    <strong>20 календарных дней</strong>
                  </li>
      ...
      <section className="services" id="services">
        <div className="container">
          ...
          <div className="expertise-process">
            ...
            <ol>
              <li>
                <strong>Сроки:</strong> Средний срок проведения экспертиз — 20
                календарных дней
              </li>
              <li>
                <strong>Стоимость:</strong> Определяется после ознакомления с
                кругом вопросов и материалами дела
              </li>
              <li>
                <strong>Точность:</strong> Использование сертифицированного
                оборудования и инструментов
              </li>
              <li>
                <strong>Эффективность:</strong> Взаимодействие с судом через
                электронную почту для ускорения процесса
              </li>
            </ol>
          </div>
        </div>
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <p>
                      656049, г. Барнаул,
                      <br />
                      пр-кт Красноармейский, 77 корпус Б оф.301
                    </p>
                  </div>
                </div>
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <p>
                      <a href="tel:+73852608877" style={{ color: "inherit" }}>
                        +7 (3852) 60-88-77
                      </a>
                    </p>
                    <p>
                      <a href="tel:+79132108877" style={{ color: "inherit" }}>
                        +7 (913) 210-88-77
                      </a>
                    </p>
                  </div>
                ...
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <p>
                      <a
                        href="mailto:info@ooo-ekspertiza.ru"
                        style={{ color: "inherit" }}
                      >
                        info@ooo-ekspertiza.ru
                      </a>
                    </p>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-about">
              ...
              <p>
                Специализированные судебные экспертизы и экспертные
                исследования. Качество и надежность с 2022 года.
              </p>
              <div className="requisites">
                <p>
                  <strong>ИНН:</strong> 2222896938
                </p>
              </div>
            </div>
            <div className="footer-links">
              <h3>Навигация</h3>
              <ul>
                {(["hero", "about", "services", "contact"] as const).map(
                  (id) => {
                    const labels: Record<string, string> = {
                      hero: "Главная",
                      about: "О компании",
            ...
            <div className="footer-contact">
              <h3>Контакты</h3>
              <p>
                <i className="fas fa-map-marker-alt" /> г. Барнаул, пр-кт
                Красноармейский, 77 корпус Б оф.301
              </p>
              <p>
                <i className="fas fa-phone-alt" />{" "}
                <a href="tel:+73852603051" style={{ color: "inherit" }}>
                  +7 (3852) 60-30-51
                </a>
              </p>
              <p>
              ...
              <p>
                <i className="fas fa-clock" /> Пн–Пт: 9:00 – 18:00
              </p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>
              &copy; 2025 ООО «ЭКСПЕРТИЗА». Все права защищены. ИНН 2222896938
            </p>
          </div>
        </div>
      </footer>
          ...
          <div className="cookie-consent-content">
            <div className="cookie-consent-text">
              <p>
                ...
                использования сайта. Ознакомьтесь с нашей{" "}
                <a
                  href="/privacy-policy"
                  target="_blank"
                  rel="noopener noreferrer"
