...
const IconBalanceScale = () => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor">
    <path
      d="M12 2v18M4 20h16M12 2l-7 10h14L12 2z"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.8"
      strokeLinecap="round"
          ...
          <div className="footer-content">
            ...
            <div className="footer-contact">
              ...
              <p>
                ...
                г. Барнаул, пр-кт Красноармейский, 77 корпус Б оф.301
              </p>
              <p>
                <span className="footer-icon">
                  <IconPhone />
