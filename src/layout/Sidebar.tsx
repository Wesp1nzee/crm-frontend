...
const menuItems = [
  ...
  { text: "Доступно мне", path: "/crm/share/inbox", icon: <MoveToInbox /> },
...
export function Sidebar({ open }: SidebarProps) {
  ...
  return (
    <Box
      sx={{ p: 0, position: "relative", width: sidebarWidth, flexShrink: 0 }}
    >
      <Drawer
        variant="permanent"
        sx={{
          ...
          "& .MuiDrawer-paper": {
            ...
            transition:
              "width 0.3s ease, border-radius 0.25s ease, box-shadow 0.25s ease",
            overflowX: "hidden",
