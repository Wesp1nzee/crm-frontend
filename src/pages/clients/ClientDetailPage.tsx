...
export function ClientDetailPage() {
  ...
  if (error || !client) {
    return (
      <Alert severity="error">Не удалось загрузить карточку клиента</Alert>
    );
  }
  ...
  return (
    <Stack spacing={3}>
      ...
      <Card
        sx={{ borderRadius: 3, border: "1px dashed", borderColor: "divider" }}
      >
        <CardContent>
            ...
            <Box display="flex" alignItems="flex-start" gap={1.25} flex={1}>
              ...
              <Box>
                ...
                <Typography
                  variant="body2"
                  color={
                    client.legal_address ? "text.primary" : "text.secondary"
                  }
                >
            ...
            <Box display="flex" alignItems="flex-start" gap={1.25} flex={1}>
              ...
              <Box>
                ...
                <Typography
                  variant="body2"
                  color={
                    client.actual_address ? "text.primary" : "text.secondary"
                  }
                >
