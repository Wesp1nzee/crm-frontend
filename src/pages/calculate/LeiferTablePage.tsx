...
const FLOOR_OPTIONS = ["средний этаж", "последний этаж", "первый этаж"];
...
const LeiferTableContent = memo(
  ({
    rows,
    onValueChange,
  }: {
    rows: LeiferRow[];
    onValueChange: (rowId: string, colIndex: number, value: string) => void;
  }) => {
    return (
                  ...
                  row.values.map((value, colIndex, arr) => (
                    <TableCell
                      ...
                      sx={{
                        textAlign: "center",
                        fontWeight:
                          row.type === "calculated" || row.type === "result"
                            ? "bold"
                            : "normal",
                    ...
                    >
                      {row.isEditable ? (
                        <TextField
                          ...
                          value={value}
                          onChange={(e) =>
                            onValueChange(row.id, colIndex, e.target.value)
                          }
                          inputProps={{
...
export function LeiferTablePage() {
  ...
  const handleAnalogMetadataChange = useCallback(
    (analogIndex: number, field: string, value: string) => {
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Регион"
                  onChange={(e) =>
                    handleObjectMetadataChange("region", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Тип жилья"
                  onChange={(e) =>
                    handleObjectMetadataChange("housingType", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Материал стен"
                  onChange={(e) =>
                    handleObjectMetadataChange("wallMaterial", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    handleObjectMetadataChange("location", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Лоджия/балкон"
                  onChange={(e) =>
                    handleObjectMetadataChange("balcony", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Этажность"
                  onChange={(e) =>
                    handleObjectMetadataChange("floor", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    handleObjectMetadataChange("houseCondition", e.target.value)
                  }
                  MenuProps={menuProps}
                  sx={selectStyle}
                >
        ...
        <CardContent>
          ...
          {analogsMetadata.map((analog, analogIndex) => (
            <Box key={analogIndex} sx={{ mb: 2 }}>
              ...
              {analogIndex < analogsMetadata.length - 1 && (
                <Divider sx={{ mt: 2 }} />
              )}
            </Box>
          ))}
